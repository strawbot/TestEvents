...
public:
    ...
    void test1Cpp() {
        ...
        press(events);
        once(button, this, action1);
        stopEvent(button, this, action1);
        printf("\nTest6 stop action before button press");
        press(events);
        once(button, this, action1);
        when(button, this, action2);
        stopEvent(button, this, action1);
        stopEvent(button, this, action2);
    }
    void test2Cpp() {
        ...
        printf("\nTest1 no handler button press");
        cpress(events);
        once(cbutton, this, action1);
        printf("\nTest2 with action1");
        cpress(events + 1);
        printf("\nTest3 no handler button press");
        cpress(events);
        printf("\nTest4 multiple (3) button presses");
        when(cbutton, this, action2);
        cpress(events + 2);
        cpress(events + 2);
        cpress(events + 2);
        never(cbutton);
